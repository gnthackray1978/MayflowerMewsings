...
export default function FTMViewTable(props) {
  ...
  const [orderBy, setOrderBy] = React.useState('yearStart');
  ...
  console.log('FTMViewTable : ' + page + ' ' + order + ' ' + orderBy );
  ...
  return (
    <MuiThemeProvider theme={theme}>
      <div className={classes.root}>
          ...
          <FTMViewTableToolbar numSelected={selected.length} filterParams ={filterParams} title = 'FTMView'
